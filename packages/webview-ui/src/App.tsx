...
export function App({ bootstrap }: { bootstrap: Bootstrap }): ReactElement {
  switch (bootstrap.page) {
    ...
    case 'fundHoldings':
      return <FundHoldingsPage code={bootstrap.code} items={bootstrap.items} error={bootstrap.error} />;
    case 'fundRanking':
    ...
    case 'aiResult':
      return <AiResultPage title={bootstrap.title} result={bootstrap.result} />;
    case 'leekCenter':

...
export function FundHoldingsPage({ code, items, error }: { code: string; items?: FundHolding[]; error?: string }): ReactElement {
  return <DataPage title={`${code} 主要持仓`} loading={!items && !error} error={error}>{items?.length
